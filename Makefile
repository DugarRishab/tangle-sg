...
SRC = $(SRC_DIR)/main.cpp $(MODULES_DIR)/pow.cpp $(MODULES_DIR)/tsa.cpp $(MODULES_DIR)/network.cpp $(MODULES_DIR)/tangle.cpp $(MODULES_DIR)/peers2.cpp $(MODULES_DIR)/transaction.cpp $(MODULES_DIR)/utils.cpp
